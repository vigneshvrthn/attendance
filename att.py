...
mydb = psycopg2.connect(host="localhost", user="postgres", password="vignesh", port=5432, database="att")
mycursor = mydb.cursor()
st.title("Attendance calculator")
with st.sidebar:    
    select_fun=option_menu("Menu",["Insert staff","Editing staff","Deleting staff","Calculate salary"])
